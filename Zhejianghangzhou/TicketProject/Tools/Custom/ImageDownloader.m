...
@synthesize monitorEnabled = _monitorEnabled;
...
@synthesize isMessageImage = _isMessageImage;
...
- (void)startDownload:(NSString *)urlMain {
    ...
    if (isBundleImage) {
        _downloadImage = [[UIImage imageNamed:urlMain] retain];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)theConnection {
    NSString *downloadDataStr = [[NSString alloc] initWithData:_downloadData encoding:NSUTF8StringEncoding];
    [downloadDataStr release];
