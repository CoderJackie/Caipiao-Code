...
//#define OpenUDIDLog(fmt, ...) YX_Log_Debug((@"%s [Line %d] " fmt), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__);
//#define OpenUDIDLog(fmt, ...) YX_Log_Debug((@"[Line %d] " fmt), __LINE__, ##__VA_ARGS__);
