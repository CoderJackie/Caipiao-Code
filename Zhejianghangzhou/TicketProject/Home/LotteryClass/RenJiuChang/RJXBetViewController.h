...
@interface RJXBetViewController : UIViewController<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, ASIHTTPRequestDelegate, UIAlertViewDelegate, CustomAlertViewDelegate,SelectBallsDetailViewControllerDelegate> {
