    ...
    if([[[[self url] scheme] lowercaseString] isEqualToString:@"https"]) {       
        ...
        if (![self validatesSecureCertificate]) {
            ...
            NSDictionary *sslProperties = [[NSDictionary alloc] initWithObjectsAndKeys:
                                      ...
                                      kCFNull,kCFStreamSSLPeerName,@"kCFStreamSocketSecurityLevelTLSv1_0SSLv3", kCFStreamSSLLevel,
                                      nil];
...
- (void)reportFinished
{
#if LOG_SWITCH_HTTP || LOG_SWITCH_HTTP_DETAIL
    NSDictionary *contentDic = [[self responseString]objectFromJSONString];
#endif
#if LOG_SWITCH_HTTP
    NSLog(@"HTTP-Response-Finished : error:%@  msg:%@",[contentDic objectForKey:@"error"],[contentDic objectForKey:@"msg"]);
#endif
#if LOG_SWITCH_HTTP_DETAIL
    NSLog(@"HTTP-Response-Finished : %@",contentDic);
#endif
...
{
#if LOG_SWITCH_HTTP || LOG_SWITCH_HTTP_DETAIL
    NSLog(@"HTTP-Response-Failed : %@",[self responseString]);
#endif
